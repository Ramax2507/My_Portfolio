...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="bg-white dark:bg-gray-900/80 py-20 px-4 relative rounded-xl border-4 border-white/60 backdrop-blur-2xl shadow-lg"
    >
        ...
        <div className="relative mt-6">
          ...
          >
            {projects.map(({ id, title, description1, image, github, live }) => (
              ...
              >
                <div className="bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col h-[400px]">
                  <img
                    src={image}
                    alt={title}
