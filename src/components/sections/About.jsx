...
const About = () => {
  return (
    <section id="about" className="bg-gray-900/80 rounded-2xl p-8 border-4  border-white/60  backdrop-blur-2xl shadow-lg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-2/3 space-y-4">
            <h2 className="text-3xl font-bold text-gray-900 text-white">About Me</h2>
